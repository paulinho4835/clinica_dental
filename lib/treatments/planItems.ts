...
// Fuente única de "precio vs. pagado" por tratamiento del plan de un paciente.
// La consumen /api/patients/[id]/plan-items (dropdown de pago) y /cuentas
// (barra de progreso por tratamiento) — mismos números en ambos lugares
// porque leen exactamente la misma consulta, no dos cálculos separados.
export async function fetchPatientPlanItems(
